          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">
                ...
                <a href="{{ url('panel/blog/add') }}" class="btn btn-success" style="float: right; margin-top: 5px;">Add New</a>
              </h5>
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{ url('panel/blog/edit/'.$value->id) }}" class="btn btn-success btn-sm">Edit</a>
                      <a onclick="return confirm('Are you sure you want to delete records?');" href="{{ url('panel/blog/delete/'.$value->id) }}" class="btn btn-danger btn-sm">Delete</a>
                    </td>
                  </tr>
                  @empty
                  <tr>
